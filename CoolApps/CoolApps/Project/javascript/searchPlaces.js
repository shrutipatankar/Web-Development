  ...
  //  alert("In doc ready");
    ...
    */
    ...
    /* 
       ...
       This function detects the current location of the user and calls the respective function 
       based on whether it was able to detect the user or not.
       
       On successful call: handleGetCurrentPosition() function is called
       On unsuccessful call: onError() function is called*/
    function getGeoLocation() {
    ...
    /* 
        Function: handleGetCurrentPosition: Object (pos) -> calls relevent function based on tab
        This function constructs a URL needed for the google Places API
        It first gets the user's latitude and longitude and appends this location along with the 
        google Places APIs key and then calls the function getDatafromGooglePlacesAPI() function     
    */
    function handleGetCurrentPosition(pos) {
